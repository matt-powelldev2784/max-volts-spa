  ...
  public: {
    Tables: {
      ...
      invoice_product: {
        ...
        Relationships: [
          {
            foreignKeyName: "invoice_product_invoice_id_fkey"
            columns: ["invoice_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "invoice_product_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
      ...
      quote_product: {
        ...
        Relationships: [
          {
            foreignKeyName: "quote_product_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "product"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "quote_product_quote_id_fkey"
            columns: ["quote_id"]
            isOneToOne: false
